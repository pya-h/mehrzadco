...
// import from '../assets/vids/about.mp4';
...
const generalServices = [
        ...
        details: [
            {
             ...
             آپارتمانی مسکونی، ساختمان های اداری ، ساختمان های فرهنگی و تجاری میباشد. خدمات ما در رابطه با طراحی و معماری در گروه مهندسی و ساخت مهرزاد شامل :
        ...
        details: [
            {
             ...
             که این امر در گروه مهندسی و ساخت مهرزاد در قالب خدماتی مانند نظارت های جلسه ای طراح، حضور ناظران مقیم در پروژه از طرف دفتر معماری و نیز تولید نقشه های دو بعدی و سه بعدی اظافی با توجه به نیاز کارگاه در هر مرحله محقق میشود. ما در طول نظارت ،شرایط پیشرفت و توسعه هر پروژه را به صورت هفتگی
    ...
    },
    {
        ...
        details: [
            {
                text: `ما در گروه مهندسی و ساخت مهرزاد با تشکیل شبکه گسترده ای از حرفه ای ترین پیمانکاران ایران خدمات گسترده ای را در زمینه اجرای طراحی 
